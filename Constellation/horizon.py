#https://github.com/steveberardi/starplot/blob/main/examples/horizon_sgr.py
...
dt = timezone("CET").localize(datetime(10, 8, 30, 21, 0, 0, 0))

p = HorizonPlot(
    altitude=(0, 60),
    azimuth=(135, 225),
    lat=9.606111,  # Lone Pine, California
    lon=-118.079444,
    dt=dt,
    style=style,
    resolution=4000,
